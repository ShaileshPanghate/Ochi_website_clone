...
function Footer() {
  return (
    <div className="flex gap-5 w-full h-[115vh] bg-zinc-900 p-20">
      <div className="w-1/2 h-full flex flex-col justify-between font-['Founders Grotesk']">
        <div className="heading">
          <h1 className="text-[8vw]  uppercase -mb-20 tracking-tighter">
            eye-
          </h1>
          <h1 className="text-[8vw]  uppercase -mb-20 tracking-tighter">
            Opening
      ...
      <div className="w-1/2 font-['Founders Grotesk']">
        <div>
          <h1 className="text-[7vw]  uppercase tracking-tighter">
            presentations
          </h1>
        </div>
        <div className="list font-['Neue Montreal']">
          <div>
